...
| 版本 | 日期 | 主要變更 |
|------|------|----------|
| v0.1.10 | 2026-09-11 | AI 助手改為內嵌於聊天流（工作階段內顯示），取代右側浮動面板；JS 檔加入 cache-bust 版本號 |
| v0.1.9 | 2026-09-11 | 通用 `pre>code` 規則，修復 AI 面板 LeRobot 代碼淺底淺字問題 |
| v0.1.8 | 2026-09-11 | AI 面板寬度改 40%（上限 640px）；robot-log 代碼區塊深底白字 |
| v0.1.7 | 2026-09-11 | Demo 模式合成 webcam 畫面（無圖時繪製模擬桌面）；`getAnnotatedImage` 自動 initCanvas 防 null |
| v0.1.6 | 2026-09-11 | Demo 模式新增工作階段自動產生 6 個 mock 物件，無需上傳圖片 |
| v0.1.5 | 2026-09-11 | 新增 Demo 模式（離線 AI）與 LeRobot 代碼生成器、5 分頁 AI 助手 |
